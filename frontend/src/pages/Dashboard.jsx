...
const Dashboard = () => {
  ...
  // a function to check if a date is within a given range (inclusive)
  ...
  // to calculate data for income, expenses and savings
  ...
  // to update gauge data when transactions or time frame changes
  ...
  // to calculate percentage change in income, expenses and savings compared to previous time frame
  ...
  // expense distribution data for the pie chart, using overviewMeta if available for monthly view, otherwise calculating from transactions
  ...
  const fetchDashboardOverview = async () => {
    try {
      ...
      if (res?.data?.success || res?.ok) {
        const data = (await res.json()) || res.data.data;
